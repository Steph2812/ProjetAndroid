...
import kotlinx.android.synthetic.main.activity_ble_cell_parent.view.*
import kotlinx.android.synthetic.main.activity_ble_cell_parent.view.uuidParent
...
class BLEDeviceAdapter(
    ...
    class ServiceViewHolder(itemView: View) : GroupViewHolder(itemView) {
        val serviceName: TextView = itemView.nomParent
        val serviceUUID: TextView = itemView.uuidParent
    }

    class CharacteristicViewHolder(itemView: View) : ChildViewHolder(itemView) {
        val characteristicUUID: TextView = itemView.uuidE
        val characteristicProperties: TextView = itemView.propriete
        val characteristicValue: TextView = itemView.valeur
        val characteristicNom : TextView = itemView.caract_spe

        val characteristicReadAction: Button = itemView.button_lecture
        val characteristicWriteAction: Button = itemView.button_ecriture
        val characteristicNotifyAction: Button = itemView.button_notification
